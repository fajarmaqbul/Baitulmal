    ...
    return (
        <nav className="sidebar" id="sidebar">
            ...
            <ul className="nav">
                ...
                {(hasPermission('Zakat Fitrah') || hasPermission('Zakat Mal') || hasPermission('Zakat Produktif') || hasPermission('Sedekah') || hasPermission('Santunan') || hasPermission('Donasi Tematik')) && (
                    <>
                ...
                {(hasPermission('Kepengurusan') || hasPermission('Data Asnaf') || hasPermission('Event & Panitia')) && (
                    <>
                ...
                {(hasPermission('Manajemen Produk') || hasPermission('Etalase UMKM')) && (
                    <>
                        ...
                        {openCategories.umkm && (
                            <>
                                {hasPermission('Manajemen Produk') && (
                                    <li className="nav-item menu-items">
                ...
                {(hasPermission('Riwayat Pesan') || hasPermission('Sekretariat') || hasPermission('Pengaturan')) && (
                    <>
